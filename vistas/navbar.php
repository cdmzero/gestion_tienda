...
<link rel="shortcut icon" type="image/x-icon" href="/gestion_tienda/imagenes/mifavicon.png"/>
 <!-- Static navbar -->
 <nav class="navbar navbar-inverse  navbar-static-top">
  ...
  <div class="navbar-header">
    ...
    <li class="active"><a href="/gestion_tienda/index.php">Menu</a></li> 
    </ul>
    <ul class="nav navbar-nav navbar-right">
          <?php if(!isset($_SESSION['email'])){?>
            ...
            <li><a href="/gestion_tienda/vistas/login.php"><span class="glyphicon glyphicon-log-in"></span> Login</a></li>
            <?php }else{ ?>
            <li class="active"><a href="#"><span class="glyphicon glyphicon-user"></span> <?php echo $_SESSION['email'] ;?></a></li>
            <li><a href="/gestion_tienda/vistas/login.php"><span class="glyphicon glyphicon-log-out"></span> Salir</a></li>
          <?php } ?>  
    </ul>
    <?php
    ...
    <form class="navbar-form navbar-right" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
      <div class="form-group">
        <input type="text" id="buscar" name="articulo" class="form-control" placeholder="Buscar articulo">
      </div>
